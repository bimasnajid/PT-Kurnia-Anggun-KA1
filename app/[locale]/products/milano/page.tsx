  ...
  return (
    <section className="relative py-20 min-h-screen bg-gradient-to-b from-gray-500 to-gray-800 text-white">
      ...
      <div className="text-center mb-16">
        ...
        >
          Milano Collection Group
          <span className="absolute left-0 bottom-0 w-full h-1 bg-blue-500 rounded-full animate-pulse"></span>
        </motion.h2>
        <p className="mt-4 text-gray-300 max-w-2xl mx-auto">
          Milano Terinspirasi gaya Eropa kontemporer, Milano menghadirkan desain
          mewah dan detail halus. Cocok untuk pasar premium dengan kebutuhan
          estetika tinggi.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            ...
            >
              <Image
                src="/projectImages/Milano/milano74.png"
          ...
          {/* Content */}
          <h3 className="font-bold text-2xl mb-3">Milano 74</h3>
        ...
        >
          ...
          >
            ...
            >
              <Image
                src="/projectImages/Milano/milano9d.png"
                alt="Divisi Distribusi"
                fill
                className="object-contain select-none"
              />
          ...
          {/* Content */}
          <h3 className="font-bold text-2xl mb-3">Milano 9 Drawer Dresser</h3>
          <p className="text-gray-400">
            Menjangkau konsumen lokal & internasional dengan jaringan distribusi
            yang terpercaya.
          </p>
        ...
        >
          ...
          >
            ...
            >
              <Image
                src="/projectImages/Milano/milanocoffe.png"
                alt="Divisi Distribusi"
                fill
                className="object-contain select-none"
              />
          ...
          {/* Content */}
          <h3 className="font-bold text-2xl mb-3">Milano Coffe Table</h3>
          <p className="text-gray-400">
            Menjangkau konsumen lokal & internasional dengan jaringan distribusi
            yang terpercaya.
          </p>
        ...
        >
          ...
          >
            ...
            >
              <Image
                src="/projectImages/Milano/milanoKing.png"
                alt="Divisi Distribusi"
                fill
                className="object-contain select-none"
              />
          ...
          {/* Content */}
          <h3 className="font-bold text-2xl mb-3">Milano Bed King</h3>
          <p className="text-gray-400">
            Menjangkau konsumen lokal & internasional dengan jaringan distribusi
            yang terpercaya.
          </p>
        ...
        >
          ...
          {/* Content */}
          <h3 className="font-bold text-2xl mb-3">Milano Bed Queen</h3>
          <p className="text-gray-400">
            Menjangkau konsumen lokal & internasional dengan jaringan distribusi
            yang terpercaya.
          </p>
        ...
        >
          ...
          >
            ...
            >
              <Image
                src="/projectImages/Milano/milanonaturalking.png"
                alt="Divisi Distribusi"
                fill
                className="object-contain select-none"
              />
        ...
        >
          ...
          >
            ...
            >
              <Image
                src="/projectImages/Milano/milanonaturalquen.png"
                alt="Divisi Distribusi"
                fill
                className="object-contain select-none"
              />
